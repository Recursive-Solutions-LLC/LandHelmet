...
import { HeaderLink, HeaderProps } from "@/app/interfaces";
...
const Header: FC<HeaderProps> = ({ headerLinks }) => {
    ...
    const renderNavItems = headerLinks.map((header, index) => (
        <HeaderNavItem
            key={index}
            header={header}
        />
    ...
    return (
        <Popover className={"font-title text-black container mx-auto flex justify-between items-center border-b-2 border-black text-2xl px-6 py-2 h-24 mb-8 z-1"}>
            ...
            <Link className="flex-none text-xl font-title text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/" aria-label="Brand">
                <Image src="/images/logo/png/logoX1.png" width={170} height={50} alt="logo" />
            </Link>

            {!isMobile && (
                <>
                    <div className="grow">
                        <div className="flex items-center justify-end mr-10 gap-2 md:gap-8">
                            {renderNavItems}
                        </div>
                    </div>
            ...
            {isMobile && (
                ...
                bg-white p-2 text-black hover:bg-gray-500 focus:outline-none focus:ring-2
                ...
                transition  block opacity-100">
                            <div className="rounded-lg bg-white shadow-lg ring-1  divide-y-2 opacity-100 block
                    divide-gray-50">
                                <div className="px-5 pt-5 pb-6 opacity-100">
                                    <div className="flex items-center justify-between">
                                        ...
                                        bg-white p-2 text-black hover:bg-gray-100 hover:text-gray-500 focus:outline-none
